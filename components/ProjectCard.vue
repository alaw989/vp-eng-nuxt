<template>
  ...
  >
    ...
    <!-- Project Content -->
    <div class="p-6">
      <div v-if="category" class="inline-block px-3 py-1 text-xs font-semibold text-primary bg-primary/10 rounded-full mb-3">
        {{ category }}
      </div>
      ...
      <!-- Project Meta -->
      <div v-if="location || year" class="flex items-center gap-4 text-sm text-neutral-500">
